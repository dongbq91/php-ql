                                ...
                                <table class="table table-borderless">
                                    <tr>
                                        <td>
                                            ...
                                            <input type="text" value="<?=$tenkh?>" class="form-control" id="tenkhachhang" name="tenkhachhang" required style="background: #fff9c8">

                                        </td>
                                        <td> <label for="uname" >Email</label>
                                            <input type="email" value="<?=$email?>" class="form-control" id="email" name="email" required style="background: #fff9c8">
                                        </td>
                                    ...
                                    <tr>
                                        <td>
                                            ...
                                            <input type="text" value="<?=$diachi?>" class="form-control" id="diachi" name="diachi" required style="background: #fff9c8">

                                        </td>
                                        <td>
                                            <label for="uname" >Số chứng minh</label>
                                            <input type="text" value="<?=$id?>" class="form-control" id="sochungminh" name="sochungminh"  required style="background: #fff9c8">
