...
if(!empty($_POST)){
    ...
    $sql1='SELECT * FROM cuocgoi WHERE MaCuocGoi="'.$macuoc.'" ';
    $sql='INSERT INTO cuocgoi (MaCuocGoi,TenCuocGoi,PhiCuocGoi) VALUES("'.$macuoc.'","'.$tencuoc.'",'.$phicuoc.')';
    ...
    if($check == null ){
        ...
        echo '<script language="javascript">';
        echo 'alert("Mã cước gọi đã tồn tại")';
        echo '</script>';
    }
}
?>
                    ...
                    <div class="card-body ">
                        <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF'])?>" method="post" onsubmit="validate()">
                            <table class="table table-borderless">
                                <tr>
                                    <td> <label for="uname" >Mã gói cước</label>
