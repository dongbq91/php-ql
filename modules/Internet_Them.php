...
if(!empty($_POST)){
    ...
    $sql1='SELECT * FROM internet WHERE MaGoiInternet="'.$macuoc.'" ';
    $sql='INSERT INTO internet (MaGoiInternet,TenGoiInternet,PhiGoiInternet) VALUES("'.$macuoc.'","'.$tencuoc.'",'.$phicuoc.')';
                    ...
                    <div class="card-body ">
                        <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF'])?>" method="post" onsubmit="validate()">
                            <table class="table table-borderless">
                                ...
                                <tr>
                                    <td>
                                        <label for="uname" >Phí Internet(VND)</label>
